...
export const metadata = { title: "Генерация Gemini 3 Pro Image + референс — тест картинок" };
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          <nav className={styles.breadcrumb}>
            ...
            <span>Gemini 3 Pro Image + референс</span>
          </nav>
          <h1 className={styles.title}>Реклама в Telegram Ads, которая окупается</h1>
          <p className={styles.subtitle}>Сгенерировано через <strong>Gemini 3 Pro Image + референс</strong></p>
