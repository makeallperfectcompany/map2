...
export const metadata = { title: "Генерация Gemini 3 Pro Image — тест картинок" };
    ...
    <div className={styles.wrapper}>
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.subtitle}>Сгенерировано через <strong>Gemini 3 Pro Image</strong></p>
