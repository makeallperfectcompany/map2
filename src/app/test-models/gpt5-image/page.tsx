...
export const metadata = { title: "Генерация GPT-5 Image — тест картинок" };
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          <nav className={styles.breadcrumb}>
            ...
            <span>GPT-5 Image</span>
          </nav>
          <h1 className={styles.title}>Реклама в Telegram Ads, которая окупается</h1>
          <p className={styles.subtitle}>Сгенерировано через <strong>GPT-5 Image</strong></p>
