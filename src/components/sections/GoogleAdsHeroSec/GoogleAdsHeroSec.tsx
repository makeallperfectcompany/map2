...
import styles from "./GoogleAdsHeroSec.module.css";
...
const trustItems = [
  ...
  { label: "Компетенции в Google Ads", value: "ведём контекст под заявки и продажи" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function GoogleAdsHeroSec({ content }: Props) {
  return (
