...
import styles from "./GoogleSeoHero.module.css";
...
const trustItems = [
  ...
  { label: "Компетенции в SEO", value: "продвигаем сайты в Google под результат" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function GoogleSeoHero({ content }: Props) {
  return (
