...
export default function GoogleSeoProcessSection({ title, text, image, items }: Props) {
  const icons = [
      ...
      <Container>
        <div className={`${grid.grid2} ${styles.layout}`}>
          ...
          <div className={styles.visualCard}>
            <Image src={image} alt="Процесс SEO-продвижения в Google — Make All Perfect" width={1200} height={1500} sizes="(max-width: 768px) 100vw, 48vw" />
          </div>
        </div>
      </Container>
    </section>
