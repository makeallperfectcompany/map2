      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.left}>
            ...
            {/* Mobile/Tablet: Visual card with integrated bullets (≤1024px) */}
            <div className={styles.heroCardVisual}>
              ...
              <div className={styles.cardBullets}>
                <div className={styles.cardBullet}>
                  ...
                  <span className={styles.cardBulletText}>Стратегия и рост</span>
                </div>
                <div className={styles.cardBullet}>
                  <div className={styles.featIco}>
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <span className={styles.cardBulletText}>Дизайн и контент</span>
                </div>
                <div className={styles.cardBullet}>
                  <div className={styles.featIco}>
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <span className={styles.cardBulletText}>Реклама и аналитика</span>
                </div>
                <div className={styles.cardBullet}>
                  <div className={styles.featIco}>
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <span className={styles.cardBulletText}>SEO и разработка</span>
                </div>
              </div>
            </div>
