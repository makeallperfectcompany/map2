...
import styles from "./KontekstnayaReklamaHero.module.css";
...
const trustItems = [
  ...
  { label: "Компетенции в Директ", value: "ведём контекст под заявки и продажи" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function KontekstnayaReklamaHero({ content }: Props) {
  return (
