...
import styles from "./LokalnoeSeoHero.module.css";
...
const trustItems = [
  ...
  { label: "Компетенции в SEO", value: "продвигаем сайты, карточки и 2ГИС" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function LokalnoeSeoHero({ content }: Props) {
  return (
