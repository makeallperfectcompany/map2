...
export default function LokalnoeSeoProcessSection({ title, text, image, items }: Props) {
  return (
      ...
      <Container>
        <div className={`${grid.grid2} ${styles.layout}`}>
            ...
            <div className={styles.timeline}>
              {items.map(([itemTitle, itemText], index) => {
                const icons = [
                  ...
                  <svg key="6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>,
                ];
                return (
          ...
          <div className={styles.visualCard}>
            <Image src={image} alt="Процесс локального SEO-продвижения — Make All Perfect" width={1200} height={1500} sizes="(max-width: 768px) 100vw, 48vw" />
          </div>
        </div>
      </Container>
    </section>
