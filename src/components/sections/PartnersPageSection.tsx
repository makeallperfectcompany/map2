      ...
      <section className={styles.hero} aria-labelledby="partners-title">
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <h1 id="partners-title">Зарабатывайте на рекомендациях клиентов</h1>
            <p>
              Передавайте компании, которым нужен сильный маркетинг. Ведение берём на себя — вы получаете 10–20% от сделки.
            </p>
