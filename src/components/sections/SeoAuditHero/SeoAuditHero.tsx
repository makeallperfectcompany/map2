...
import styles from "./SeoAuditHero.module.css";
...
const trustItems = [
  ...
  { label: "Экспертный аудит", value: "не чек-лист, а стратегия с приоритетами" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function SeoAuditHero({ content }: Props) {
  return (
