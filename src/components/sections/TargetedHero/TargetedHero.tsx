...
import styles from "./TargetedHero.module.css";
...
const trustItems = [
  ...
  { label: "Таргетинг под бизнес", value: "сегменты, креативы, аналитика и оптимизация" },
  { label: "Полная прозрачность", value: "вы видите стратегию, цифры и ход работ" },
];

export default function TargetedHero({ content }: Props) {
  return (
