...
export default function VkAdsProcessSection({ title, text, image, items }: Props) {
  return (
      ...
      <Container>
        <div className={`${grid.grid2} ${styles.layout}`}>
          ...
          <div className={styles.visualCard}>
            <Image src={image} alt="Процесс настройки рекламы ВКонтакте — Make All Perfect" width={1200} height={1500} sizes="(max-width: 768px) 100vw, 48vw" />
          </div>
        </div>
      </Container>
    </section>
